...
const technologiesSelecy = document.querySelector('#calculator-form-technologies')



const technologiesMultiSelect = new Choices(technologiesSelecy, {
    allowSearch: false,
    silent: false,
    renderChoiceLimit: -1,
    maxItemCount: -1,
...
function calculateSum()
{
    ...
    const websiteCartSelect = document.querySelector('#calculator-form-input-cart input:checked');
    const websiteReceptionSelect = document.querySelector('#calculator-form-input-reception input:checked');
